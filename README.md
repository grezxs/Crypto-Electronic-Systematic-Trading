...
| `frontend/index.html` | Web terminal — live monitor + controls (served by `scripts/serve_frontend.py` or Vercel) |
| `src/part7_dashboard/state.py`, `control.py` | JSON bridge: bot ↔ terminal (`runtime/state.json` + `control.json`) |
