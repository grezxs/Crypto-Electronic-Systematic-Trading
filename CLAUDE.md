...
7. **Dashboard.** Web terminal (`frontend/index.html`) wired to live state via the JSON bridge (`src/part7_dashboard/state.py` + `control.py`), served by `scripts/serve_frontend.py` (or Vercel `api/`).
8. **Backtester.**
